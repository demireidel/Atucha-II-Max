              ...
              <ErrorBoundary>
                ...
                >
                  <Suspense fallback={null}>
                    ...
                    <directionalLight position={[-50, 50, -50]} intensity={0.6} color="#e6f3ff" />
                    <pointLight position={[0, 50, 0]} intensity={0.8} color="#fff8dc" distance={200} decay={2} />

                    <Environment preset="city" background={false} />
                    <fog attach="fog" args={["#f0f8ff", 100, 400]} />
